...
SEVERITY_KW = {
    "Critical": ["not breathing","no pulse","unconscious","collapsed","cardiac arrest",
                 ...
                 "stopped breathing","unresponsive","murder","gunshot"],
    "High":     ["fire","burning","explosion","stabbed","shot","shooting",
                 "attacked","severe pain","chest pain","difficulty breathing",
                 "head injury","broken bone","fracture","electrocuted","trapped","crash","suicide","dowry","alimony"],
